...
import com.kingfish.show.mybatis.model.SpiderTrackExample.Criteria;
import com.kingfish.show.mybatis.model.SpiderTrackExample.Criterion;
import com.kingfish.show.mybatis.model.SpiderTrackExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SpiderTrackSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(SpiderTrackExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("spider_track");
     ...
     * @mbg.generated
     */
    public String deleteByExample(SpiderTrackExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("spider_track");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(SpiderTrack record) {
        SQL sql = new SQL();
     ...
     * @mbg.generated
     */
    public String selectByExample(SpiderTrackExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SpiderTrack record = (SpiderTrack) parameter.get("record");
        SpiderTrackExample example = (SpiderTrackExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("spider_track");
        ...
        if (record.getNum() != null) {
            sql.SET("num = #{record.num,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(SpiderTrack record) {
        SQL sql = new SQL();
        sql.UPDATE("spider_track");
        ...
        if (record.getNum() != null) {
            sql.SET("num = #{num,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, SpiderTrackExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
